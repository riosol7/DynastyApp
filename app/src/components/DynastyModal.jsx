                    ...
                    <div>
                        <div>
                            <div className="d-flex">
                                <div className="">
                                    <img className="rounded-circle" alt="avatar" src={`https://sleepercdn.com/avatars/thumbs/${
                                ...
                                :
                                    ...
                                    <p> avg: { roundToHundredth(roundToHundredth((roster.kct.qb.players.reduce((r,c) => r + Number(c.age), 0)/ roster.kct.qb.players.length) +
