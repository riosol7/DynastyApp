            ...
            <>
                <div className="">
                    ...
                    <div className="my-5 d-flex">
                        <div style={{background:"linear-gradient(90deg, rgba(116,178,221,1) 0%, rgba(114,202,224,1) 20%, rgba(51,193,189,1) 50%, rgba(80,204,147,1) 100%)", width:"5px", borderRadius:"2rem"}}></div>
