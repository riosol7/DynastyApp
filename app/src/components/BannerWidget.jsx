        ...
        { loadRosters ? <p>Loading </p> :
            <div>
                <div className="d-flex">
                    ...
                    <SwiperSlide>
                        <div className="col-sm-12" style={{maxHeight:"223.22px",border:"0px solid black", borderRadius:"5px", backgroundImage: "linear-gradient(to right, rgb(242, 112, 156), rgb(255, 148, 114))", color:"white"}}>
                            <p className="m-0" style={{fontSize:"2.5rem"}}>Draft {league.season}</p>
                            <p className="m-0" style={{fontSize:"2.5rem"}}>1st Overall Pick</p>
                            <Icon icon="arcticons:voteinfo" style={{fontSize:"8em"}}/>
                        </div>
                    </SwiperSlide>
                    </Swiper>
                </div>
